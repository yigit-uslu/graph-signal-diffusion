# DEPRECATED: moved to src/graph_signal_diffusion/cli/stock/analyze_dates.py
# Use: python -m graph_signal_diffusion.cli.stock.analyze_dates  or  stock-analyze-dates
"""
