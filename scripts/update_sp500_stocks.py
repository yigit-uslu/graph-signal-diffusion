#!/usr/bin/env python3
# DEPRECATED: moved to src/graph_signal_diffusion/cli/stock/update_stocks.py
# Use: python -m graph_signal_diffusion.cli.stock.update_stocks  or  stock-update-stocks
"""
