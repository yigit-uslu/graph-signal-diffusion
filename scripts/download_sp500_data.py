#!/usr/bin/env python3
# DEPRECATED: moved to src/graph_signal_diffusion/cli/stock/download.py
# Use: python -m graph_signal_diffusion.cli.stock.download  or  stock-download
"""
...
from update_sp500_stocks import fetch_sp500_sector_info
