#!/usr/bin/env python3
# DEPRECATED: moved to src/graph_signal_diffusion/cli/stock/sweep_dynamic_graph.py
# Use: python -m graph_signal_diffusion.cli.stock.sweep_dynamic_graph  or  stock-sweep-dynamic-graph
"""
