...
# time (seaborn darkgrid, huge fonts, custom mathtext).  We lazy-import
# ``draw_stocks_graph_by_correlation`` inside the one function that uses
# it so that merely importing this module does *not* pollute global
# rcParams.  See Phase 2 of the plot-style cleanup.
